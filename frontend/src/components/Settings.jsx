...
const Settings = ({ user }) => {
    ...
    return (
        <div className="max-w-5xl mx-auto p-6 lg:p-12 min-h-full flex flex-col md:flex-row gap-8">
            ...
            <div className="flex-1 bg-white dark:bg-gray-800 rounded-3xl border border-gray-100 dark:border-gray-700 shadow-sm p-8 min-h-[500px] transition-colors relative overflow-hidden">
